...
exports.mapEolSpeciesToLTP = void 0;
var mapEolSpeciesToLTP = function (input) {
    return {
        eolId: input.identifier,
        binomial: input.scientificName,
        vernacularNames: input.vernacularNames.map(function (name) {
            return {
...
exports.mapEolSpeciesToLTP = mapEolSpeciesToLTP;
var input = {
    identifier: 1114974,
...
var species = (0, exports.mapEolSpeciesToLTP)(input);
console.log(species);
